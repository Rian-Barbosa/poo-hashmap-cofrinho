...
Aprimoramento com HashMap de trabalho desenvolvido para a disciplina de Programação Orientada a Objetos. Simulação de cofre digital, rondando no console, que armazena diferentes tipos de moeda e calcula seus valores.
## 📌 Descrição
...
- **Cofrinho.java** → Gerencia a lista de moedas, armazenada em HashMap, e operações (adicionar, remover, total)
...
#### Clone o repositório
`git clone https://github.com/rian-barbosa/poo-hashmap-cofrinho.git`
